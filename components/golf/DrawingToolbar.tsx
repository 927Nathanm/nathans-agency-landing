...
import { MousePointer, Minus, ArrowRight, Circle, Square, Pen, Triangle, GitBranch, Undo2, Redo2, Trash2 } from 'lucide-react'
...
const TOOLS: { id: DrawingTool; icon: React.ReactNode; label: string }[] = [
  { id: 'select', icon: <MousePointer className="h-4 w-4" />, label: 'Select — click an annotation, then Delete/Backspace to remove' },
